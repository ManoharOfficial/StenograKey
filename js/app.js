(function (_, $, Backbone) {
    ...
    // current character for selection, and returns that character on touch.
    var FingerView = View.extend({
        ...
        getElasticDistance: function (distance) {
            // Use Apple's formula for rubberband scrolling:
            // b = (1.0 – (1.0 / ((x * c / d) + 1.0))) * d
            // where x is the distance from the edge, c is a constant (Apple
            // uses 0.55), and d is a dimension of the rubberbanding item.
